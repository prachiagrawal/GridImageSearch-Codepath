 ...
 * position, View convertView, ViewGroup parent), which supplies a View present
 * data in a ListRow.
 * 
...
public abstract class GenericAdapter<T> extends BaseAdapter {
	...
	// Two view types which will be used to determine whether a row should be
	// displaying data or a Progressbar
	...
	/**
	 * return the type of the row, the last row indicates the user that the
	 * ListView is loading more data
	 */
	@Override
	 ...
	 * @return
	 */
	public abstract View getDataRow(int position, View convertView,
			ViewGroup parent);
	...
	public View getFooterView(int position, View convertView, ViewGroup parent) {
		...
		if (row == null) {
			row = mActivity.getLayoutInflater().inflate(R.layout.progress_bar, parent, false);
		}
